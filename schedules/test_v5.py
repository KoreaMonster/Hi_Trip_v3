...
#             "check_duplicate": idx in {5, 10, 15, 20},
#         }
#     )
#
#
...
#     logger.info(
#         "[%%s] 표시 정보 | entrance_fee_display=%%s", case["id"], place.entrance_fee_display
#     )
...
#     logger.info(
#         "[%%s] 저렴한 항목 수=%%s", case["id"], len(cheapest)
#     )
...
#     logger.info(
#         "[%%s] 담당자 저장 | repr=%%s", case["id"], str(coordinator)
#     )
...
#         logger.info(
#             "[%%s] 총 담당자 수=%%s", case["id"], len(coordinators)
#         )
